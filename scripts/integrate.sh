...
cp "$MODULE_SRC/BBSTinyScreen.h" "$FIRMWARE_MODULES/"
cp "$MODULE_SRC/BBSTinyStatus.h" "$FIRMWARE_MODULES/"
cp "$MODULE_SRC/BBSGeoLookup.h" "$FIRMWARE_MODULES/"
cp "$MODULE_SRC/BBSSurvival.h" "$FIRMWARE_MODULES/"
cp "$MODULE_SRC/BBSGeoDB.h" "$FIRMWARE_MODULES/"
cp "$MODULE_SRC/BBSGeoUpload.h" "$FIRMWARE_MODULES/"
cp "$MODULE_SRC/BBSKBLoader.h" "$FIRMWARE_MODULES/"
